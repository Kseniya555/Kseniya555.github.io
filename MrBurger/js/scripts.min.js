...
$(function(){var e=$(".section"),t=$(".fixed-menu__item"),a=$(".catalog__item");$(".hamburger").on("click",function(){return $(this).toggleClass("on"),$(this).parent().find(".header__navigation_mobile").slideToggle(),$(".welcome__text").fadeToggle("slow"),!1}),$(".nav__link, .btn-order").on("click",function(){var e=$(this).attr("data"),i=$(this).parents(".section").index(),a=$(e).index();$(t[i]).removeClass("fixed-menu__item_active"),$(t[a]).addClass("fixed-menu__item_active"),$("html, body").animate({scrollTop:$(e).offset().top},"slow")}),$(".arrow_down").on("click",function(){var i=$(this).parent().index();$(t[i]).removeClass("fixed-menu__item_active"),$(t[i+1]).addClass("fixed-menu__item_active"),$("html, body").animate({scrollTop:$(e[i+1]).offset().top},300)}),$(".section").on("wheel",function(i){var a=$(this).index();$(".fixed-menu__item_active").removeClass("fixed-menu__item_active"),i.originalEvent.wheelDelta/120>0&&a>0?($(t[a-1]).addClass("fixed-menu__item_active"),$("html, body").animate({scrollTop:$(e[a-1]).offset().top},300)):a<e.length-1?($(t[a+1]).addClass("fixed-menu__item_active"),$("html, body").animate({scrollTop:$(e[a+1]).offset().top},300)):($(t[a]).addClass("fixed-menu__item_active"),i.preventDefault())}),$(".fixed-menu__item").on("click",function(){var t=$(this).index();$(".fixed-menu__item_active").removeClass("fixed-menu__item_active"),$(this).addClass("fixed-menu__item_active"),$("html, body").animate({scrollTop:$(e[t]).offset().top},"slow")}),$(".catalog__navigation_prev").on("click",function(){var e=$(".catalog__item_active").index();$(".catalog__item_active").removeClass("catalog__item_active"),e>0?e-=1:e=a.length-1,$(a[e]).addClass("catalog__item_active")}),$(".catalog__navigation_next").on("click",function(){var e=$(".catalog__item_active").index();$(".catalog__item_active").removeClass("catalog__item_active"),e<a.length-1?e+=1:e=0,$(a[e]).addClass("catalog__item_active")}),$(".team__item").on("click",function(){$(this).find(".team-member__dropdown").toggle()}),$(".menu-accordion__item").each(function(){$(this).attr("data","closed")}),$(".menu-accordion__item").on("click",function(){var e=$(this).index(),t=$(this).parent().find(".menu-accordion__item");if("closed"==$(t[e]).attr("data"))for(i=0;i<=e;i++)$(t[i]).css("width","50%"),$(t[i]).attr("data","opened");else if(e<t.length-1&&"opened"==$(t[e+1]).attr("data"))for(i=e+1;i<=t.length-1;i++)$(t[i]).css("width","240px"),$(t[i]).attr("data","closed");else $(t[e]).css("width","240px"),$(t[e]).attr("data","closed")}),$(".reviews-carousel").owlCarousel({loop:!0,nav:!1,smartSpeed:700,responsiveClass:!0,dots:!1,responsive:{0:{items:1},800:{items:2},1100:{items:4}}}),$(".btn-more").on("click",function(){$(".reviews-popup").fadeIn(),$("body").css("overflow-y","hidden")}),$(".btn-close").on("click",function(){$(this).parent().parent().fadeOut(),$("body").css("overflow-y","auto")}),$(function(){$("#phone").inputmask("+7 (999) 99 99 99")}),$(".order__item-check").on("click",function(){$(this).toggleClass("order__item-check_active")}),$(".order__item-radio").on("click",function(){$(".order__item-radio_active").removeClass("order__item-radio_active"),$(this).addClass("order__item-radio_active")}),$("#form-order").on("submit",function(e){e.preventDefault();var t=$(this);formData=t.serialize(),$.ajax({url:"mail.php",type:"POST",data:formData}).done(function(e){var t=e.status?".order-success":".order-error";$(t).fadeIn()})})});